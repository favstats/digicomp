...
perf_ai_tex_link <- md_text(
  ...
  "",
  "```{r, echo=FALSE, message=FALSE, warning=FALSE}",
  'create_blockquote("Which websites/apps use AI to personalize information for you?", preset = "question")',
  "```",
  "[{{< iconify ph cards >}} See all AI results](ai.html)"
)
...
translation <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vRHn6F7oL_0WCNdlwvV5WvT8JtT-XRKO2YQ8zX1zJbbPkznXGEVbXC80F4fC0NUjWK87kdirUXn6eLh/pub?gid=0&single=true&output=csv")
...
dashboard <- create_dashboard(
  ...
  add_page(
    name = transl("dashboard_title", "en"),
    text = md_text(
      "<div style='text-align: justify;'>",
      transl("landing_page_text", "en"),
      "",
      "<br>",
      "<br>",
