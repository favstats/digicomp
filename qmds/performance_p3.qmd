...
<nav class='pagination-nav pagination-top' role='navigation' aria-label='Page navigation'>
  <div class='pagination-container'>
    <a href='prestatie_p2.html' class='pagination-btn pagination-prev' aria-label='Previous page'>
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
create_blockquote("Kijk goed naar de foto's hieronder. Welke foto is niet gemaakt met artificiële intelligentie (AI)?", preset = "question")
```
