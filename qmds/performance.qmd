...
```{r perf-dccs-overtime-mig-item1}
# Identify crop icon
result <- create_timeline(
  data = data,
  title = "Identify crop icon",
...
```{r perf-netiquette-wave1-mig-item1}
# Ask for Permission to Share
result <- create_stackedbar(
...
```{r perf-netiquette-wave2-mig-item1}
# Ask for Permission to Share
result <- create_stackedbar(
...
```{r perf-netiquette-overtime-mig-item1}
# Ask for Permission to Share
result <- create_timeline(
  data = data,
  title = "Ask for Permission to Share",
