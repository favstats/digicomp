...
result <- create_stackedbars(
  ...
  title = "Which of the <a href='#PDCCS1R' class='modal-link'>following icons</a> refer to the function for cutting or removing parts of a picture ('cropping')?",
  questions = "PDCCS1R",
  question_labels = "Which of the <a href='#PDCCS1R' class='modal-link'>following icons</a> refer to the function for cutting or removing parts of a picture ('cropping')?",
  stacked_type = "percent",
  color_palette = c("#3D7271", "#E28D50", "#F5D76E", "#C7E6D5", "#0F6B5A", "#BABACD"),
  horizontal = TRUE,
  x_label = "",
