...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
create_blockquote('Look closely at <a href="#PCIS1R" class="modal-link">this post</a> on social media as well. What kind of post do you think this is?', preset = 'question')
```
