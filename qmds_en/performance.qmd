...
create_blockquote('How can you make sure that only Dutch sources are shown? Click on <a href=\"#PSIS2R\" class=\"modal-link\">the spot in the image</a> where you can indicate this.', preset = 'question')
```
...
result <- create_stackedbars(
  ...
  question_labels = c("Recognize fake news on social media", "Recognize advertisement on social media", "What do you need to look at to check whether a post on social media is fake news or not?"),
  stacked_type = "percent",
  color_palette = c("#3D7271", "#E28D50", "#F5D76E", "#C7E6D5", "#0F6B5A", "#BABACD"),
  horizontal = TRUE,
  x_label = "",
