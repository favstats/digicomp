...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
create_blockquote("Performance questions for Critical Information dimension", preset = "question")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
create_blockquote('Performance questions for Digital Content Creation dimension', preset = 'question')
```
[{{< iconify ph cards >}} See all Digital Content Creation results](digital_content_creation.html)

[{{< iconify ph:info-circle >}} Digital Content Creation & Collaboration: Performance Questions](#PDCCS1R){.modal-link}
