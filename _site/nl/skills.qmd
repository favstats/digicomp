    ...
    include-after-body:
      text: |
        <script>
          ...
          document.addEventListener("DOMContentLoaded", function () {
              document.querySelectorAll("a[href='https://favstats.github.io/digicomp/skills.html']").forEach(function(link) {
...
# data %>% count(AgeGrsoup)
# 
# ddd <- read_csv2("../../data/DigCom25CompleteWithWeights.csv") %>% #table()
...
# data$
# data %>% 
#   select(c("SInfo1", "SInfo3_V2", "SInfo4"),)
```
...
viz_general(c("SInfo1", "SInfo3_V2", "SInfo4"), 
            var_labels, 
...
the_vars <- c("SInfo5", "SInfo6", "SInfo7")
...
the_vars <- c("SCom1_V2", "SCom2", "SCom4_V2", "SCom5")
...
the_vars <- c("SCrea2", "SCrea3", "SCrea4", "SCrea5")
viz_general(the_vars, 
            var_labels, 
            categories_dat, 
            weight_var = "weging_GAMO")
...
the_vars <- c("SSafDev1", "SSafDev2", "SPriv1", "SPriv2", "SPriv3", "SPriv4", "SCom3")
...
the_vars <- c("SHealth1", "SHealth2_V2", "SHealth3_V2")
...
the_vars <- c("Strans1", "Strans2", "Strans3", "Strans4", "Strans5")
